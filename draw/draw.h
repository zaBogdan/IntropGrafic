...
void drawf (double &unitax, int &unitaxpx, int lgx, int lgy, int tx, int ty,vector<string> postfix); ///Deseneaza functie pe intervalul [a, b] intr-o fereastra de dimensiuni lgx, lgy
double tr(int coord, int translare); /// translate for a point with a zoom
void drawGraph(vector<string>);
